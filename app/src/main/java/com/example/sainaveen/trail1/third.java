...
public class third extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View parentHolder = inflater.inflate(R.layout.fragment_third, container,
                false);
        GraphView graph = (GraphView)parentHolder.findViewById(R.id.graph);
        GraphView graph1 = (GraphView)parentHolder.findViewById(R.id.graph1);
        GraphView graph2 = (GraphView)parentHolder.findViewById(R.id.graph2);
