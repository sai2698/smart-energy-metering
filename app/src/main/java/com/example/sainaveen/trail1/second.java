...
public class second extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View parentHolder = inflater.inflate(R.layout.fragment_second, container,
                false);
        TextView txt=(TextView)parentHolder.findViewById(R.id.textView3);
        Button bute=(Button)parentHolder.findViewById(R.id.button4);
        bute.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent ih=new Intent(getContext(),MainActivity.class);
                startActivity(ih);
                getActivity().finish();
            }
        });
